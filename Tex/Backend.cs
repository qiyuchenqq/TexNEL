...
public static class Backend
{
    ...
    private const string RandomLoginApiKey = "34260c63a8da4f30ac7c065d046c8d82";
    private const string CredentialsApiUrl = "https://cookie.meowow.org/api/accounts/credentials/quick";
    private const string CredentialsApiKey = "34260c63a8da4f30ac7c065d046c8d82";
    ...
    {
        var pluginDir = Tex.Utils.FileUtil.GetPluginDirectory();
    ...
    public static async Task<(bool Success, string Message)> RandomLogin4399WithCredentialsAsync()
    {
        try
        {
            ...
            InternalQuery.Initialize();
            string peCookie = await Tex.Protocol.Com4399Login.LoginWithPasswordAsync(account, password, "", "");
